    ...
    sections: [
      {
        ...
        images: [{ placeholder: "Hero — H&M app screens / cover image" }],
      },
      {
      ...
      },
      {
        ...
        images: [
          { placeholder: "Research synthesis — journey map / affinity map / behavioural data" },
        ],
      },
      {
        ...
        images: [
          { placeholder: "Product browsing — before / after", caption: "Reducing friction in product discovery and browsing." },
          { placeholder: "Size selection flow", caption: "Clarifying size selection to cut hesitation and returns." },
          { placeholder: "Checkout flow", caption: "Streamlining checkout across iOS and Android." },
        ],
      },
      {
        heading: "Design System",
        ...
        images: [
          { placeholder: "Component library & design tokens in Figma" },
          { placeholder: "Component audit — fragmented patterns → aligned system" },
        ],
      },
      {
        ...
        images: [
          { placeholder: "Moderated usability testing / iteration screens" },
        ],
      },
    ],
    outcomes: [
