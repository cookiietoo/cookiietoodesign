        ...
        <div className=" md:w-80 w-full p-3 border border-neutral-800   rounded-2xl h-full bg-[#1C1C1C]  ">
          <div className="flex">
            <div className="w-full relative">
              ...
              {open && (
                <div className="border border-lime-400 h-5 flex items-center justify-center rounded-2xl w-fit px-2 absolute top-[4.7rem] right-10 ">
          ...
          >
            <input
              ...
              className=" w-36 focus:outline-none bg-transparent text-neutral-400 text-xs placeholder:text-neutral-600 h-full pl-1 placeholder:text-xs placeholder:font-RubikMedium"
              placeholder="chhipanilesh1@gmail.com"
              type="text"
            />
            <motion.button
              animate={controls}
          ...
          <div className="w-full mt-5 text-neutral-300">
            ...
            <div className="mt-6 flex justify-between text-sm">
              ...
              <div className="flex items-center gap-x-1">
                <PiMagicWandThin />
                <span className="text-xs font-RubikRegular">28 Projects</span>
              </div>
            </div>
